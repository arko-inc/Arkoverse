        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 mb-16 mt-10">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-lg mt-4 text-white">
              I'm <span className="text-white font-semibold">Arko</span>, a
              dreamer, innovator, and aspiring space scientist, committed to
              pushing the boundaries of the possible. Let's journey together
              into the Arkoverse!
            </p>
            <Link to="/projects">
          ...
          <ul className="list-disc pl-5 space-y-4">
            <li className="p-4 transform hover:scale-105 transition duration-300">
              <span className="font-thin text-white">
                My favorite number is <span className="text-indigo-400">7</span>
                .
              </span>
            </li>
            <li className="p-4 transform hover:scale-105 transition duration-300">
