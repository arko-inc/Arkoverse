...
function AboutMe() {
  return (
    <>
      <section
        className="bg-black min-h-screen px-8 sm:px-2 py-12 md:px-20 lg:px-32 font-mont font-lightrelative bg-cover bg-fixed text-white p-5 md:p-10 lg:p-20 h-max"
        style={{
          backgroundImage:
