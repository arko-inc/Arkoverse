  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-right text-white flex flex-col justify-center h-full mr-10">
        <h1 className="text-5xl md:text-7xl mb-4 font-sans">
          Welcome <br />
        ...
        <p className="text-lg md:text-2xl max-w-2xl mb-8 font-sans text-right ml-auto  ">
          A universe of innovative ideas and limitless possibilities, crafted by
          Arko.
        </p>
        <button
          href="/projects"
          className="px-6 py-3 md:ml-24  rounded-md sm:ml-10 translate-x-10 border-white border-2  backdrop-blur-lg  hover:text-black hover:bg-white hover:border-black  bg-transparent text-md text-white  transition duration-300 font-sans w-[350px] items-left hover:scale-110"
        >
          Explore My Projects
        </button>
      </div>
